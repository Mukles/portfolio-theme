      ...
      <div className="flex flex-wrap">
        ...
        >
          <div className="lg:pt-[100px]">
            ...
            >
              Hi, <br /> I&rsquo;m{" "}
              <span className="text-primary">Niharika</span>
            </motion.h1>
            <motion.h3
              variants={fadeInUp}
              viewport={{ once: false }}
        ...
        <div className="w-full lg:basis-[58%] lg:max-w-[58%] px-[15px]">
          <div className=" pt-[50px] lg:pt-[100px] relative">
            <motion.div
              ...
              initial={"hidden"}
              whileInView={"visible"}
              className="absolute top-[53px] sm:top-[66px] lg:top-[115px] left-[25%] z-50 max-w-[15%]"
            >
              <Image
                width={72}
                height={74}
            ...
            <motion.div
              ...
              initial={"hidden"}
              whileInView={"visible"}
              className="absolute top-[28px] sm:top-[30px] lg:top-[100px] right-[30%] max-w-[10%]"
            >
              <Image
                width={41}
                height={38}
