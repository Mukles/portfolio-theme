    ...
    <div className="sm:container overflow-hidden">
      <div className="flex flex-wrap">
        <div className="w-full lg:grow-0 lg:shrink-0 lg:basis-1/2 lg:max-w-[50%] px-[15px]">
          ...
          <div className="max-w-[485px] mt-11">
            <div className="flex">
              ...
              <div className="pl-5 pb-11 relative before:content-[''] before:absolute before:w-px before:left-0 before:top-[-10px] before:h-full before:bg-[#E8E8E8] before:z-20 after:absolute after:w-[5px] after:z-30 after:h-[5px] after:top-3 after:bg-primary -after:top[12px after:rotate-45 after:left-[-2px]">
                <h3 className="text-[16px] leading-[32px] text-primary">BSC</h3>
            ...
            <div className="flex">
              ...
              <div className="pl-5 relative before:content-[''] before:absolute before:w-px before:left-0 before:top-[-10px] before:h-full before:bg-[#E8E8E8] before:z-20 after:absolute after:w-[5px] after:z-30 after:h-[5px] after:top-3 after:bg-primary -after:top[12px after:rotate-45 after:left-[-2px]">
                <h3 className="text-[16px] leading-[32px] text-primary">BSC</h3>
                <h4 className="text-xl leading-[24px] text-heading mb-3 font-medium">
                  Computer Science
                </h4>
...
"
            />
            <h1 className="section-title">My Experiecne</h1>
          </div>
          <div className="max-w-[485px] mt-11">
            <div className="flex">
              <span className="w-[90px] flex-none text-[16px] leading-[32px] text-heading font-light">
